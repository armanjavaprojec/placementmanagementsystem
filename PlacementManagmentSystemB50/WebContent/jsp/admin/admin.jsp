...
<script type="${path}/js/jquery-3.1.1.min.js"></script>
...
<body class="no-skin">
	<div class="main-container" id="main-container">
		...
		<h4 class="pink">
			...
			<b class="blue">Welcome To Admin</b>
		</h4>
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="${path}/images/banner/admin1.jpg" alt="Los Angeles"
							style="width: 100%;">
					</div>

					<div class="item">
						<img src="${path}/images/banner/admin2.jpg" alt="Chicago"
							style="width: 100%;">
					</div>

					<div class="item">
						<img src="${path}/images/banner/hr1.jpg" alt="New york"
							style="width: 100%;">
					</div>
				</div>
