		...
		<div class="prog-page">
			...
			<div id="user-profile-1" class="user-profile row">
				<div class="col-xs-12 col-sm-3 center">
					 ...
					 <i	class="ace-icon fa fa-circle light-green"></i> &nbsp; <span	class="white" id="fname"></span>
					...
					<div class="col-md-9">
						<div class="prof-info">
							...
							<div class="info">
								<label><i class="fa fa-calendar"></i><b>Email :</b></label> <span id="email"></span>
							</div>
							<div class="info">
								<label><i class="fa fa-male"></i><b>Mobile :</b></label> <span id="mob"></span>
							</div>

							<div class="info">
								<label><i class="fa fa-map-marker"></i><b>Zip Code :</b></label> <span id="pin"></span>
							</div>

							
							<div class="info">
								<label><i class="fa fa-map-marker"></i><b>State :</b></label> <span id="state"> </span>
									, <span id="country"></span>
							</div>
							<div class="info">
								<label><i class="fa fa-male"></i><b>Address :</b></label> <span id="addrs"></span>
							</div>
