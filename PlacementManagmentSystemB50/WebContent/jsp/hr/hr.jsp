...
<body class="no-skin">
	<div class="main-container" id="main-container">
		...
		<h4 class="pink">
			...
			<b class="blue">Welcome to HR</b>
		</h4>

		<!--  Show all Perticular Notifications to HR -->
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="${path}/images/banner/hr1.jpg" alt="Los Angeles"
							style="width: 100%;">
					</div>

					<div class="item">
						<img src="${path}/images/banner/hr2.jpg" alt="Chicago"
							style="width: 100%;">
					</div>

					<div class="item">
						<img src="${path}/images/banner/hr3.jpg" alt="New york"
							style="width: 100%;">
					</div>
				</div>
	...
	${result}
		...
		%>
		<span style="color: green; font-size: 15px;">${pwd_msg}!</span><i
			class="material-icons" style="font-size: 48px; color: green">mood</i>
		<%
			}
		%>
