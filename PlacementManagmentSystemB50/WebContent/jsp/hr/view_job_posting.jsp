			...
			<tbody>
					<c:forEach var="jobList" items="${jobList}">
						<tr>
							...
							<td>
									<div><a href="<%=application.getContextPath() %>/jsp/hr/update_posting.jsp?id=${jobList.jobPostingId}&desc=${jobList.description}&expDate=${jobList.expDate}&postDate=${jobList.postDate}&vacancies=${jobList.noOfVacancies}"><button type="submit" class="btn btn-primary btn-sm btn-block" >Edit</button></a></div>
