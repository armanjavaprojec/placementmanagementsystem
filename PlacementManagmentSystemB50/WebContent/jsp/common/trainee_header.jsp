             ...
             opt="<li></li>";
                $.each(data,function(k,v){
                    ...
                    opt+="<li style='LINE-HEIGHT:20px;' id='li'>We have openings in "+v.clientName+" for "
                               ...
                               +v.clientDescription+"</div><button id='btn1"+k+"' value='"+v.jobPostId+"' sytle='height:0px; width:0px; visibility:hidden;'></button><button id='check"+k+"' value='"+v.countryid+"' style='visibility:hidden; height:0px; width:0px;'></button><hr></li>";
                });
...
function validate(r){
 ...
 var jbpstid=document.getElementById("btn1"+a).value;
             ...
             opt="<li></li>";
                $.each(data,function(k,v){
                   if(v.not_status_id==0 || v.not_status_id==1){
                    ...
                    +v.description+" ("+v.roundNo+" ) of "+v.clientName+" of process .<button type='button' class='btn btn-link' onclick='roundInfo(this)' id='btn"+k+"'>more..</button><button id='btn2"+k+"' value='"+v.job_post_id+"' sytle='height:0px; width:0px; visibility:hidden;'></button><button id='round"+k+"' value='"+v.roundNo+"' sytle='height:0px; width:0px; visibility:hidden;'></button></li>";
                });
...
//show perticular round data
 function roundInfo(r){
	    var a=$(r).parents('li').index()-1;
         var jbpstid=document.getElementById("btn2"+a).value;
